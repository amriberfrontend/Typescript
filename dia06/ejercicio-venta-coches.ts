...
class Coche implements IValorable {
    ...
    constructor(id: string, tipoRueda: Rueda, carroceria: Carroceria, volante: Volante, precio: number)  {
        this.id = id;
...
const rueda2 = new Rueda("r2", 150, Terreno.TODO_TERRENO);
const rueda3 = new Rueda("r3", 130, Terreno.CARRETERA);
const rueda4 = new Rueda("r4", 140, Terreno.NIEVE);
...
const coche1 = new Coche("coche1", rueda1, carroceria1, volante1, 15000);
